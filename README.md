...
- **5,066 picture → asset_bundle mappings** embedded (from all 21 card XMLs; static — no updates needed)
...
| Data | Source | Entries |
|------|--------|---------|
| Picture → Asset Bundle map | `cards_section_1–21.xml` | 5,066 |
| ID → Card name map | `cards_section_1–21.xml` | 55,548 |
| Skill definitions & descriptions | `skills_set.xml` | 50 skills |
| Trigger map | `cards_section_1–21.xml` | 18 trigger-capable skills |
